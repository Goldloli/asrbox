...
从 [`v0.1.9` Release](https://github.com/Goldloli/asrbox/releases/tag/v0.2.0) 下载对应平台的安装包（macOS Apple Silicon 为 DMG，Windows x64 为 NSIS 安装程序），并校验 `SHA256SUMS.txt`。
