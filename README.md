...
从 [`v0.3.0` Release](https://github.com/Goldloli/asrbox/releases/tag/v0.3.1) 下载对应平台的安装包（macOS Apple Silicon 为 DMG，Windows x64 为 NSIS 安装程序），并校验 `SHA256SUMS.txt`。
