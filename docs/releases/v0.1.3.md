![ASRbox demo](https://raw.githubusercontent.com/Goldloli/asrbox/v0.1.3/assets/asrbox-demo.gif)
...
[中文 README](https://github.com/Goldloli/asrbox/blob/v0.1.3/README.md) · [English README](https://github.com/Goldloli/asrbox/blob/v0.1.3/README.en.md)

> 当前 DMG 未签名、未公证，仅支持 Apple Silicon Mac。首次打开如提示"ASRbox.app 已损坏"，在终端执行一次 `xattr -cr /Applications/ASRbox.app` 即可，详见 README。

## 下载

- [ASRbox_0.1.3_aarch64.dmg](https://github.com/Goldloli/asrbox/releases/download/v0.1.3/ASRbox_0.1.3_aarch64.dmg) — macOS Apple Silicon 安装包
- [SHA256SUMS.txt](https://github.com/Goldloli/asrbox/releases/download/v0.1.3/SHA256SUMS.txt) — DMG 与源码包校验值
- [ASRbox-ffmpeg-source-8.1.2.tar.gz](https://github.com/Goldloli/asrbox/releases/download/v0.1.3/ASRbox-ffmpeg-source-8.1.2.tar.gz) — 内置 FFmpeg 对应源码与构建材料
...
![AI 字幕核对](https://raw.githubusercontent.com/Goldloli/asrbox/v0.1.3/assets/asrbox-llm-proofread.gif)
...
- 全部变化见 [CHANGELOG](https://github.com/Goldloli/asrbox/blob/v0.1.3/CHANGELOG.md)。
