...
Current release: [`v0.2.1`](https://github.com/Goldloli/asrbox/releases/tag/v0.3.0). The Apple Silicon DMG and the Windows x64 NSIS installer are available from the Release assets and are not bundled with model weights.
