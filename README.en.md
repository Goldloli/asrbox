...
The current source version is `0.2.0`. It is suitable for evaluation and feedback, not a stable release.
...
Download the installer for your platform from the [`v0.1.9` Release](https://github.com/Goldloli/asrbox/releases/tag/v0.2.0) (DMG for macOS Apple Silicon, NSIS installer for Windows x64) and verify `SHA256SUMS.txt`.
